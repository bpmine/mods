...
minetest.register_chatcommand("gban", {
	...
	func = function(name, params)
		...
		"[FRANCBAN] " .. name .. " à banni pour une durée définitive " .. plname .. " pour la raison:" .. reason))
		local ok, e = xban.ban_player(plname, name, nil, reason)
		return ok, ok and ("Banned %s."):format(plname) or e
	end,
})

minetest.register_chatcommand("gtempban", {
	...
	func = function(name, params)
		...
		minetest.chat_send_all(minetest.colorize("#ff0000",
		"[FRANCBAN] " .. name .. " à tempban " .. plname .. " pour la raison:" .. reason))
...
minetest.register_chatcommand("gunban", {
